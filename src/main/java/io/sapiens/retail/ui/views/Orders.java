...
import io.sapiens.retail.ui.layout.size.Bottom;
...
import io.sapiens.retail.ui.util.css.WhiteSpace;
...
public class Orders extends SplitViewFrame {
  ...
  private Grid createGrid() {
    ...
    grid.addColumn(new ComponentRenderer<>(this::createFromInfo))
        .setHeader("From")
        .setWidth("200px");
    grid.addColumn(new ComponentRenderer<>(this::createToInfo)).setHeader("To").setWidth("200px");
